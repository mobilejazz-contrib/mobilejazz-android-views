...
public class FontawesomeDrawable extends FontIconDrawable {
	...
	public FontawesomeDrawable(Context context, char character, int color, float textSize) {
		super(TypefaceHelper.getTypeface(context, "fontawesome.ttf"), character, color, textSize);
	}
